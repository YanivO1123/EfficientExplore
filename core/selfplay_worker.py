                    ...
                    while not dones.all() and (step_counter <= self.config.max_moves):
                        ...
                        for i in range(env_nums):
                            ...
                            if start_training:
                                ...
                                # If started training and the env is deep sea, we must act deterministically
                                if 'deep_sea' in self.config.env_name:
                                    deterministic = True

                            # In deep sea when planning with visit counter, we do not want starting random actions
