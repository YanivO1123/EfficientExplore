...
cdef class Roots:
    ...
    #TODO: Add prepare_explore function
...
cdef class Node:
    ...
    #TODO: Add __cinit__ with the new signature for node
    def __cinit__(self, float prior, int action_num):
        # self.cnode = CNode(prior, action_num)
        pass

    #TODO: Add expand with the new signature
...
#TODO: Add batch_back_propagate with the new signature
