...
cdef extern from "cnode.h" namespace "tree":
    cdef cppclass CNode:
        ...
        #TODO: Add new CNode declaration
        int visit_count, to_play, action_num, hidden_state_index_x, hidden_state_index_y, best_action
        #TODO: Add new CNode variables (I think there are only floats)
        ...
        #TODO: Add new expand function signature
        ...
        #TODO: Add new get_mean_q_uncertainty function signature
    ...
    cdef cppclass CRoots:
        ...
        #TODO: Add prepare_explore function signature
        void clear()
    ...
    #TODO: Add new cback_propagate function declaration
    ...
    #TODO: Add new cbatch_back_propagate function declaration
